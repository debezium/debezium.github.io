...
As always, please refer to the link:/releases/1.5/release-notes/#release-1.5.0-cr1[release notes] for the complete list of resolved issues as well as procedures for upgrading to earlier Debezim versions.
