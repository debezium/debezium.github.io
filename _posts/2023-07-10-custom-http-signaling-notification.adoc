...
Declare the `HTTP` signal and notification channels in the `META-INF/services` directory under `io.debezium.pipeline.signal.channels.SignalChannelReader` and
