...
Alright, let’s start building the application! All the proposed code is available on https://github.com/debezium/debezium-examples/quarkus-native[GitHub] (branch *native* for the final result, *main* for the debezium quick-start).
