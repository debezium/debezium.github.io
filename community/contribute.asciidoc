...
1. Get your development environment set up with the latest code, following the instructions in https://github.com/debezium/debezium/blob/main/CONTRIBUTE.md[CONTRIBUTE.md].
...
5. Make your changes and create a pull request, following our https://github.com/debezium/debezium/blob/main/CONTRIBUTE.md#making-changes[guidelines].
