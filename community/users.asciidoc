...
* Tokopedia
* TouchBistro (https://engineering.touchbistro.com/ingesting-postgres-shards-into-a-redshift-data-warehouse-with-kafka-and-debezium-2c1d8d487761[details])
* Traveloka
...
* https://seatunnel.apache.org/docs/2.3.13/connectors/formats/debezium-json[Apache SeaTunnel]
