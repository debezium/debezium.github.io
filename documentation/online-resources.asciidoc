...
* https://speakerdeck.com/gunnarmorling/practical-change-data-streaming-use-cases-with-apache-kafka-and-debezium["Practical Change Data Streaming Use Cases With Apache Kafka and Debezium"] by Gunnar Morling; JokerConf St. Petersburg 2019
