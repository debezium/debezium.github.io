...
* https://speakerdeck.com/gunnarmorling/practical-change-data-streaming-use-cases-with-apache-kafka-and-debezium-qcon-san-francisco-2019["Practical Change Data Streaming Use Cases With Apache Kafka and Debezium"] by Gunnar Morling; QCon San Francisco 2019; JokerConf St. Petersburg 2019 (video recording coming soon)
