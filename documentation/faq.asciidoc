...
== Oracle Connector fails with ORA-00600
...
```
The solution here is to enable supplemental logging on db level.

```
ORA-00600: internal error code, arguments: [kdli_iread], ...
```
This one can be solved by upgrading the Oracle db to 19.25 and applying patch 32209850.
