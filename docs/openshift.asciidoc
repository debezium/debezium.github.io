...
First we install the controllers and templates for the Kafka broker and Kafka Connect into our OpenShift project:
...
broker-kafka-0                                1/1       Running     0          7m
broker-topic-controller-d644d665-stmsr        1/1       Running     0          7m
broker-zookeeper-0                            1/1       Running     0          7m
debezium-connect-1-build                      0/1       Completed   0          3m
debezium-connect-2-build                      0/1       Completed   0          2m
debezium-connect-2-sxv5f                      1/1       Running     0          1m
strimzi-cluster-controller-6c9d4949b6-cpksl   1/1       Running     0          7m
----
