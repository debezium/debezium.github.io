...
The latest version of Debezium includes support for monitoring link:/docs/connectors/mysql[MySQL database servers] and link:/docs/connectors/mongodb[MongoDB replica sets or sharded clusters]. Support for other DBMSes will be added in future releases.
