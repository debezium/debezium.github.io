...
* https://blog.etlworks.com/2019/03/27/real-time-change-replication-with-kafka-and-debezium/["Real-time change replication with Kafka and Debezium"] by Etlworks
