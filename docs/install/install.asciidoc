...
* https://repo1.maven.org/maven2/io/debezium/debezium-connector-oracle/{install-dev-version}/debezium-connector-oracle-{install-dev-version}-plugin.tar.gz[Oracle Connector plugin archive] (tech preview)
* https://repo1.maven.org/maven2/io/debezium/debezium-connector-sqlserver/{install-dev-version}/debezium-connector-sqlserver-{install-dev-version}-plugin.tar.gz[SQL Server Connector plugin archive] (tech preview)
