...
[[release-0-9-0-cr1]]
== *Release 0.9.0.CR1* _(January 19th, 2018)_
...
SQL Server connector also adds a new field to offsets in streaming mode (https://issues.jboss.org/browse/DBZ-1090[DBZ-1090]) which could prevent seamleass upgrading of versions.
