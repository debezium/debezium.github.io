...
[NOTE]
====
It is worth saying that those using Confluent ecosystem should be aware that their KSQL tool , by default , does not print messages with null as value while aiming DELETE CDC this will be printed perfectly using standard Kafka consumer application.
