...
At the start time Debezium queries database for the timezone settings but it is possible to configure setting explicitly using `database.serverTimezone` configuration option.
