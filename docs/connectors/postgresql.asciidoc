...
The fifth snapshot mode, *exported*, will perform a database snapshot based on the point in time when the replication slot was created.  This mode is useful when you want to perform snapshots in a lock-free way for a new connector.
