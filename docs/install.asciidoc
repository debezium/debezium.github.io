...
* https://repo1.maven.org/maven2/io/debezium/debezium-connector-oracle/{debezium-version}/debezium-connector-oracle-{debezium-dev-version}-plugin.tar.gz[Oracle Connector plugin archive] (tech preview)
