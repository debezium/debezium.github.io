...
The backlog is tracked in https://issues.redhat.com/browse/DBZ-3899[DBZ-3899], please join the discussion on the mailing for discussing the scope for Debezium 2.0.
