...
[[release-3.0.8-final]]
== *Release 3.0.8.Final* _(March 3rd 2025)_

See the https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12317320&version=12443558[complete list of issues].
...
When you decide to upgrade one of these connectors to 3.0.8.Final from any earlier versions,
first check the migration notes for the version you're using.
Gracefully stop the running connector, remove the old plugin files, install the 3.0.8.Final plugin files, and restart the connector using the same configuration.
Upon restart, the 3.0.8.Final connectors will continue where the previous connector left off.
