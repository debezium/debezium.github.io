...
See the https://issues.jboss.org/secure/ReleaseNote.jspa?projectId=12317320&version=12339267(complete list of issues).
...
* Debezium Postgres replication with pgoutput plugin sending events slowly for non-batched insertions https://issues.jboss.org/browse/DBZ-1515[DBZ-1515]
* ExtractNewRecordState access operation field before checking message format https://issues.jboss.org/browse/DBZ-1517[DBZ-1517]
...
* Go back to original PG 10 container image for testing https://issues.jboss.org/browse/DBZ-1504[DBZ-1504]
* Support delete propagation in end-to-end demo https://issues.jboss.org/browse/DBZ-1506[DBZ-1506]
* Update Unwrap/UnwrapMongoDB SMT demos to use latest Debezium and delete event support https://issues.jboss.org/browse/DBZ-1516[DBZ-1516]
