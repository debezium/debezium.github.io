...
[[release-3.5.2-final]]
== *Release 3.5.2.Final* _(June 2nd 2026)_

See the https://github.com/orgs/debezium/projects/5/views/6?filterQuery=status%3AReleased+stable-iteration%3A3.5.2.Final[complete list of issues].

=== Kafka compatibility

This release has been built against Kafka Connect 4.1.2 and has been tested with version 4.1.2 of the Kafka brokers.
...
When you decide to upgrade one of these connectors to 3.5.2.Final from any earlier versions,
first check the migration notes for the version you're using.
Gracefully stop the running connector, remove the old plugin files, install the 3.5.2.Final plugin files, and restart the connector using the same configuration.
Upon restart, the 3.5.2.Final connectors will continue where the previous connector left off.
...
* Update to Kafka 4.1.2 https://github.com/debezium/dbz/issues/2008[debezium/dbz#2008]



[[release-3.5.1-final]]
== *Release 3.5.1.Final* _(May 14th 2026)_

See the https://github.com/orgs/debezium/projects/5/views/6?filterQuery=status%3AReleased+stable-iteration%3A3.5.1.Final[complete list of issues].
...
When you decide to upgrade one of these connectors to 3.5.1.Final from any earlier versions,
first check the migration notes for the version you're using.
Gracefully stop the running connector, remove the old plugin files, install the 3.5.1.Final plugin files, and restart the connector using the same configuration.
Upon restart, the 3.5.1.Final connectors will continue where the previous connector left off.
As one might expect, all change events previously written to Kafka by the old connector will not be modified.
...
To properly handle save-points and other partial rollback scenarios, a new `rollbacks` cache was added to the Oracle Connector.
