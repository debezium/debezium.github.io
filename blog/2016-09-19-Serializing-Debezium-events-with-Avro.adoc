...
It is true that using the Avro converter and deserializer requires a running Scheam Registry, and that the registry becomes an integral part of your streaming infrastructure. However, this is a small price to pay for the benefits listed above.
