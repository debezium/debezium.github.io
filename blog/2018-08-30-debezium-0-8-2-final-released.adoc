...
The 0.8.2 release contains 10 fixes overall, most of them dealing with issues related to DDL parsing as done by the Debezium link:/docs/connectors/mysql/[MySQL connector].
...
Thanks a lot to community members https://github.com/jchipmunk[Andrey Pustovetov], https://github.com/CliffWheadon[CliffWheadon] and https://github.com/oripwk[Ori Popowski] for their contributions to this release!
