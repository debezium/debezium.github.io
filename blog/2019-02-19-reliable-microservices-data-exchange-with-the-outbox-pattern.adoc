...
[NOTE]
===============================
Depending on the amount of data (number of records, frequency of changes),
it may or may not be feasible to keep events in Apache Kafka for a long or even indefinite time.
