...
Besides the upgrade to Apache Kafka 2.2.1 (https://issues.jboss.org/browse/DBZ-1316[DBZ-1316]),
this mostly fixes some bugs, including a regression to the MongoDB connector introduced in the Alpha2 release
(https://issues.jboss.org/browse/DBZ-1317[DBZ-1317]).
...
(https://issues.jboss.org/browse/DBZ-1242[DBZ-1242]).
